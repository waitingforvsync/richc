...
/*
 * Determinant of a 4x4 matrix using the full Leibniz expansion (24 terms).
 *
 * The formula is obtained by cofactor expansion along the first column.  Each of
 * the 24 signed products corresponds to one of the 4! = 24 permutations of the
 * column indices.
 */
...
/*
 * Inverse of a 4x4 matrix using the 2x2 sub-determinant method.
 *
 * s0..s5 are the six 2x2 sub-determinants from the upper-left 2x4 sub-matrix
 * (columns cx, cy crossed with rows x/y and y/z, etc.).
 * c0..c5 are the corresponding sub-determinants from the lower-right 2x4 block
