/*
 * math/mat33f.h - 3x3 single-precision float matrix (rc_mat33f).
 *
...
/*
 * Determinant via the scalar triple product: det = cx . (cy x cz).
 * Equivalent to the full Leibniz expansion for a 3x3 column-major matrix.
 */
