 ...
 *
 * RC_LOWER_BOUND_VIEW_CTX_PARAM_ is the leading parameter list - "VIEW view" or
...
#  endif
#  define RC_LOWER_BOUND_VIEW_CTX_PARAM_  RC_LOWER_BOUND_VIEW view, RC_LOWER_BOUND_CTX *ctx
#else
#  ifndef RC_LOWER_BOUND_CMP
#    define RC_LOWER_BOUND_CMP(a, b) ((a) < (b))
#  endif
#  define RC_LOWER_BOUND_CMP_(a, b)       RC_LOWER_BOUND_CMP(a, b)
#  define RC_LOWER_BOUND_VIEW_CTX_PARAM_  RC_LOWER_BOUND_VIEW view
#endif

static inline uint32_t
RC_LOWER_BOUND_NAME(RC_LOWER_BOUND_VIEW_CTX_PARAM_, RC_LOWER_BOUND_TYPE value)
{
    uint32_t lo = 0;
...
#undef RC_LOWER_BOUND_VIEW_CTX_PARAM_
